...
export const jobScheduleService = {
  ...
  updateBatch: (code, payload) => api.patch(`/job-schedule/batches/${encodeURIComponent(code)}`, payload),
  removeBatch: (code) => api.delete(`/job-schedule/batches/${encodeURIComponent(code)}`),
