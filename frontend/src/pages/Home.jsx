  ...
  return (
    <>
      <SEO
        ...
        description="Angular Physics offers physics-only courses for JEE Main & Advanced, NEET, and Physics Olympiads — mentored entirely by Abhishek Garg, producer of double-digit AIRs in IIT-JEE & NEET."
        path="/"
      />
